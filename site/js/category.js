...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var categories = [
    ...
    { name: 'General', slugPath: 'כללי' },
    { name: 'Articles', slugPath: 'news/מאמרים' },
    { name: '3D', slugPath: 'news/מאמרים/3d-מאמרים' },
    { name: 'HTML 5', slugPath: 'html-5' },
    { name: 'Jobs in Development', slugPath: 'דרושים-בפיתוח' }
  ];

  /* Extract slug path from URL: /category/news/מאמרים/ → news/מאמרים */
  ...
  if (metaDesc) metaDesc.setAttribute('content', 'Articles about ' + category.name + ' on the OneCode site');
